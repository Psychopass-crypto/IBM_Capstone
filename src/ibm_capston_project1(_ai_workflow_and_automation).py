# -*- coding: utf-8 -*-
"""IBM Capston Project1( AI WorkFlow and Automation).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZqQSOgyYd-tm9khmqQ6wXVzaHsVLxhy1
"""
...
def fetch_ts(data_dir, clean=False):
    ...
    if len(os.listdir(ts_data_dir)) > 0:
        ...
        return({re.sub("/var/Invoice1.json","",cf)[3:]:pd.read_csv(os.path.join(ts_data_dir,cf)) for cf in os.listdir(ts_data_dir)})
...
print("... processing data for loading")
    ...
    countries = [os.path.join(data_dir,"ts-"+re.sub("\s+","_",c.lower()) + "/var/Invoice1.json") for c in top_ten_countries]
